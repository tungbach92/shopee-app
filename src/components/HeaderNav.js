        ...
        <nav className="header__nav">
          <div className="header__nav-list">
            <li className="header__nav-item">
              <a href="# " className="header__nav-item-link">Kênh Người Bán</a>
            </li>
            <li className="header__nav-item header__nav-item--qr">
              <a href="# " className="header__nav-item-link">Tải ứng dụng</a>
          ...
          <ul className="header__nav-list">
            <li className="header__nav-item-right header__nav-item-right--notify">
              <a href="# " className="header__nav-item-link"
                ><i className="header__nav-icon bi bi-bell"></i>Thông Báo</a
              >
              <div className="header__notify">
                ...
                <a href="# " className="header__notify-showAll">Xem tất cả</a>
              </div>
            </li>
            ...
            <div
              className="header__nav-item-right header__nav-item-right--reg header__nav-item-right--user"
            >
              <div className="header__nav-reg">
                <a href="# " className="header__nav-login">Đăng ký</a>
                <a href="# " className="header__nav-register">Đăng nhập</a>
              </div>
              ...
              <div className="header__user-list">
                ...
                <a href="# " className="header__user-item">Tài khoản của tôi</a>
                <a href="# " className="header__user-item">Đơn mua</a>
                <a href="# " className="header__user-item">Đăng xuất</a>
              </div>
            </div>
          </ul>
        </nav>
