...
export default class CartProduct extends Component {
  ...
  selectAll = (event) => {
    ...
    let checkedArr = cartItems.map((item) => checked);
    checkedArr = [checked, ...checkedArr, checked];
  ...
  render() {
    ...
    let { checked, isShowing } = this.state;
        ...
        <div className="grid cart-product">
          ...
          <div className="cart-product__footer">
            ...
            <div className="cart-product__shopee-wrapper">
              ...
              {isShowing && (
                <VoucherModal toggleModal={this.toggleModal}></VoucherModal>
              )}
            </div>
            ...
            <div className="cart-product__checkout-wrapper">
              ...
              <button className="btn cart-product__checkout-btn">
                Mua hàng
              </button>
            </div>
          </div>
